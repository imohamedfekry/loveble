...
import { quickEdit as quickEditApi } from "@/lib/api/apis/ai";
    ...
    return [
        {
            ...
            create() {
                ...
                dom.className =
                    "bg-muted text-popover-foreground z-50 rounded-sm border border-input p-2 shadow-md flex flex-col gap-2 text-sm";
                ...
                form.onsubmit = async (e) => {
                    ...
                    const result = await quickEditApi(
                        {
                            selectedCode,
                            fullCode,
                            instruction,
                    ...
                    const editedCode = result.data.editedCode;
